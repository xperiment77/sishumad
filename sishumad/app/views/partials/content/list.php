        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-sm-12 comp-grid">
                    ...
                    <div  class="card bg-wihte animated fadeIn page-content">
                        <div id="content-list-records">
                            <?php
                            if(!empty($records)){
                            ?>
                            <div id="page-report-body">
                                <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="">
                                            <div class="mb-2">  <a href="<?php print_link("content/view/$data[id]") ?>"><?php echo $data['upload']; ?></a></div>
                                            <div class="td-btn">
                                                <?php if($can_view){ ?>
                                                <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("content/view/$rec_id"); ?>">
                                                    <i class="fa fa-eye"></i> 
                                                </a>
                                                <?php } ?>
                                            </div>
