                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("artikel/delete/$rec_id/?csrf_token=$csrf_token"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
