...
$can_add = ACL::is_allowed("youtube/add");
$can_edit = ACL::is_allowed("youtube/edit");
$can_view = ACL::is_allowed("youtube/view");
$can_delete = ACL::is_allowed("youtube/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="">
            <div class="row ">
                <div class="col-sm-12 ">
                    <h4 ><div class="full-wrapper block">
    ...
    <div class="container-fluid">
        <div class="row ">
            ...
            <div class="col-sm-8 comp-grid">
                <?php if($can_add){ ?>
                <a  class="btn btn btn-primary my-1" href="<?php print_link("youtube/add") ?>">
                    ...
                    <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                        <ul class="breadcrumb m-0 p-1">
                            ...
                            <li class="breadcrumb-item">
                                <a class="text-decoration-none" href="<?php print_link('youtube'); ?>">
                            ...
                            <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                ...
                                <div class="col-md-6">
                                    <div class=" ">
                                        ...
                                        <div class="td-btn">
                                            <?php if($can_edit){ ?>
                                            <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("youtube/edit/$rec_id"); ?>">
