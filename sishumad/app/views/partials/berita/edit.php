                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-content1-holder" class=""> 
                                        <textarea placeholder="Enter Content" id="ctrl-content1"  rows="5" name="content1" class="htmleditor form-control"><?php  echo $data['content1']; ?></textarea>
                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-content2-holder" class=""> 
                                        <textarea placeholder="Enter Conten" id="ctrl-content2"  rows="5" name="content2" class="htmleditor form-control"><?php  echo $data['content2']; ?></textarea>
                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    </div>
                                </div>
                            </div>
