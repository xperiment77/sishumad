                        ...
                        <form id="berita-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("berita/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-content1-holder" class=""> 
                                        <textarea placeholder="Enter Content" id="ctrl-content1"  rows="5" name="content1" class="htmleditor form-control"><?php  echo $this->set_field_value('content1',""); ?></textarea>
                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="control-label" for="content2">Content </label>
                                    <div id="ctrl-content2-holder" class=""> 
                                        <textarea placeholder="Enter Conten" id="ctrl-content2"  rows="5" name="content2" class="htmleditor form-control"><?php  echo $this->set_field_value('content2',""); ?></textarea>
                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    </div>
                                </div>
                            </div>
