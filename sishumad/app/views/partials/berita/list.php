            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div class="">
                        ...
                        ?>
                        </div><h4 ><div class="full-wrapper block">
                ...
                <div  class=" animated fadeIn page-content">
                    <div id="berita-list-records">
                            ...
                            <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                ...
                                <div class="col-sm-12">
                                    <div class="card bg-white">
										...
										<a href="<?php print_link("berita/view/$rec_id"); ?>">

										<div class=" artikelhome-link-item2 flexcenter">
										<i class=" "></i><p>Buka Halaman</p> 
										</div>
										</a>
										</div>
                        ...
                        if($show_footer == true){
                        ?>
                        <div class=" card bg-success  border-top mt-2">
                            <div class="bold row justify-content-center">    
